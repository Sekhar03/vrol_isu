...
const buildSeedData = (TODAY) => {
  ...
  return [
    // CB001 — VISA · New · Awaiting merchant action
    {
      ...
      mStatus: 'DISPUTE_RECEIVED', mSubStatus: 'ACTION_REQUIRED',
    ...
    // CB003 — VISA · Chargeback Lost · Declined by admin
    {
      ...
      mStatus: 'CASE_CLOSED', mSubStatus: 'SETTLEMENT_COMPLETED',
      adjType: 'Chargeback Raise', remitter: 'AXB', beneficiary: 'FIP',
    ...
    // CB004 — VISA · Pre-Arbitration · New
    {
      ...
      mStatus: 'PRE_ARBITRATION_RAISED', mSubStatus: 'ACTION_REQUIRED',
    ...
    // CB005 — VISA · In Progress · Evidence submitted → Visa pending
    {
      ...
      mStatus: 'UNDER_REVIEW', mSubStatus: 'UNDER_REVIEW',
    ...
    // CB006 — Mastercard · Arbitration · New
    {
      ...
      mStatus: 'ARBITRATION_REQUESTED', mSubStatus: 'UNDER_REVIEW',
    ...
    // CB007 — VISA · Refund Success · Won
    {
      ...
      mStatus: 'SETTLEMENT_COMPLETED', mSubStatus: 'SETTLEMENT_COMPLETED',
    ...
    // CB032 — VISA · Deferred CB · In Progress
    {
      ...
      mStatus: 'Differed Chargeback Raise', mSubStatus: 'ACTION_REQUIRED',
